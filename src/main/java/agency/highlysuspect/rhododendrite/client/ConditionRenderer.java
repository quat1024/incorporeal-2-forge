...
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// !! COPYPASTE OF BOTANIA RenderTileCorporeaCrystalCube !!
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
public class ConditionRenderer extends TileEntityRenderer<ConditionTile> {
	...
	public ConditionRenderer(TileEntityRendererDispatcher manager) {
		super(manager);
	}
	
	@Override
	public void render(@Nullable ConditionTile cube, float f, MatrixStack ms, IRenderTypeBuffer buffers, int light, int overlay) {
		...
		if (cube != null) {
			...
			stack = cube.inventory.getStackInSlot(0); //CHANGE
