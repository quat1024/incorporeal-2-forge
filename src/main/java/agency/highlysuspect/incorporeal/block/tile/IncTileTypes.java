...
public class IncTileTypes {
	...
	public static final TileEntityType<RedstoneSequencerTile> REDSTONE_SEQUENCER = TileEntityType.Builder.create(RedstoneSequencerTile::new, IncBlocks.REDSTONE_SEQUENCER).build(null);
